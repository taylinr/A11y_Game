            ...
            >
                    <div className={'col-12 row'}>
                        ...
                        <div className={'col-6'}>
                            ...
                            {contrastRatio < 16 ? (<p>Try Again to get all points or try the next level!</p>) : null}
                        </div>
                        <div className={'col-6'}>
                            <Progress val={contrastRatio} maxval={21} label={'Contrast Ratio'} />
                        </div>
                        <div className={'col-12'}>
                            ...
                            <div className={'col-4'}>
                                <Button primary={true} target={'./'} onClick={
                                    addPoints}>
                                    Next Level
                                    <Image src={arrowRight} alt="arrow-right-icon" />
                                </Button>
